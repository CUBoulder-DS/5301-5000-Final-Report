...
det <- c("Enabled","Enabled","Enabled","Enabled","Enabled","Enabled","Enabled","Enabled","Disabled","Disabled")
det_mod <- c("FairFace=Dlib; DeepFace=OpenCV","FairFace=Dlib; DeepFace=OpenCV","FairFace=Dlib; DeepFace=mtcnn","FairFace=Dlib; DeepFace=mtcnn","FairFace=Dlib; DeepFace=fastmtcnn","FairFace=Dlib; DeepFace=fastmtcnn","FairFace=Dlib;DeepFace=ssd","FairFace=Dlib;DeepFace=ssd","FairFace,DeepFace=None","FairFace,DeepFace=None")
img_src <- c("Pre-cropped","In-The-Wild","Pre-cropped","In-The-Wild","Pre-cropped","In-The-Wild","Pre-cropped","In-The-Wild","Pre-cropped","In-The-Wild")
tib <- tibble("Detection"=det,"Detection_Model"=det_mod,"Image_Source"=img_src)
