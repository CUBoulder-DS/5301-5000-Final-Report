...
To support our analysis and conclusions on the data, we took 2,000 samples of 500 subjects under our specified test conditions from each of the UTKFace dataset and facial recognition models.  Using these samples, we generate an estimate of the distribution of population proportion for the specified group.  We find that these plots co-incide with our p-value calculations; the greater the overlap between the plots, the higher the p-value result (the same is true for reduced overlap and lower p-value).  As such, they should support us in drawing our conclusions.
