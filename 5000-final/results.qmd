...
#| tbl-cap: TODO Table of F1 score and accuracy, by each category evaluated by the models
...
combined_results %>%
  ...
  tab_options(
            # quarto.use_bootstrap=TRUE, 
              table.width = pct(100), 
              # The following settings don't do anything when the table is interactive, boooo
              # table.font.size=5,
