...
<!--PC-->
The source data, with respect to age, does not tightly adhere to the normal distribution in all cases.  This may impact our results unless we perform some other means of evaluating age (i.e. proportion analysis by age group, or bootstrapping)
