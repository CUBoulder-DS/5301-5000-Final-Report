...
A link to download the [PDF version](https://cuboulder-ds.github.io/5301-5000-Final-Report/STAT_5000_Final_Report.pdf) of this report, a link to the [Github source code](https://github.com/CUBoulder-DS/5301-5000-Final-Report) for this report, and the [Youtube presention](https://www.youtube.com/watch?v=dQw4w9WgXcQ) are available as icons in the top nav bar of this website.
:::
