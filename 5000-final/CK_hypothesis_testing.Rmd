...
>The returned *result_matrix* contains every combination of demographics and sub-demographics hypothesis testing. If there is a result that is "NA", it most likely means the sub-demographic and it's conditionals had a proportion of 0.
